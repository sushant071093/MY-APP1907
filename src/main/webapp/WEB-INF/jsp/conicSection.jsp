...
<div class="main">
<h2>Conic Section</h2>
<p>A conic section (or simply conic) is a curve obtained as the intersection of the surface of a cone with a plane; the three types are parabolas, ellipses, and hyperbolas.</p>
<p> the circle is a special case of the ellipse and considered as fourth types of conic section.</p>
<p>Every conic section has certain features, including at least one focus and directrix. Parabolas have one focus and directrix, while ellipses and hyperbolas have two of each.</p>
<p>A conic section is the set of points P whose distance to the focus is a constant multiple of the distance(or what we say perpendicular distance) from P to the directrix of the conic.</p>
</div>
